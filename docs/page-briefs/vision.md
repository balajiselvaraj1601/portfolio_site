...
| ----------------- | ------------------------------ | ------------------------------- | ------ |
| `vision-programs` | `content/pages/05_vision.json` | Context, programs, org snapshot | heavy  |

## Structure

Single section (2026-07-06 merge):

- **`vision-programs`** (alt variant): Eyebrow "Vision", title and subtitle from `pages/05_vision.json`, then two IDEA/VISION group theme-cards with CardMark/MarkEmblem, plus 4 program cards (ThemeCard) in a 2-column grid.

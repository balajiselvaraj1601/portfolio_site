...
| Resume location                             | Portfolio section    | `content/pages/` file | Transformation                                                                                                         |
| ------------------------------------------- | -------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `personal.name`, `personal.summary.lines[]` | Hero, About          | `01_about.json`       | Title set to "Technical AI Leader" (resume title was blank); 5 summary lines verbatim                                  |
| `personal.contact[]`                        | Contact              | `06_contact.json`     | **Phone dropped.** Kept: email, LinkedIn, Kaggle, location                                                             |
| `sections[id="funds"]` ("Strategic Impact") | Vision (org impact)  | `05_vision.json`      | Org impact cards derived from strategic-impact narrative                                                               |
| `sections[id="experience"]`                 | Experience           | `02_experience.json`  | 6 roles, all projects + bullets, `tier` preserved                                                                      |
| `sections[id="education"]`                  | Education            | `04_recognition.json` | 1 record; expanded with `intro`, `field`, `achievementDetail`, `summary` for Recognition credential card               |
| `sections[id="awards"]`                     | Awards               | `04_recognition.json` | 22 items verbatim                                                                                                      |
| `sections[id="publications"]`               | Publications         | `03_research.json`    | 3 items verbatim                                                                                                       |
| `sections[id="conferences"]`                | Conferences          | `03_research.json`    | 3 items verbatim                                                                                                       |
| `sections[id="kaggle_compact"]`             | Kaggle               | `04_recognition.json` | 9 competitions (rank-ordered case-study cards) + global rank line; derived from `resume_builder/wiki/projects/kaggle/` |
| (derived)                                   | Collaborations strip | `01_about.json`       | Organization logos on About                                                                                            |
| (derived)                                   | Vision (programs)    | `05_vision.json`      | Program cards and infographic hubs                                                                                     |

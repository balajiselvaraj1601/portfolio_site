...
| #   | Rule                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| V1  | Content source: `content/pages/05_vision.json` only.                                                                                                                                                                                                                                                                                                                                                                                      |
...
| --------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| vision-programs | `src/components/sections/VisionPrograms.astro` (+ `sections/vision/` sub-components incl. `VisionImpactGrid.astro`) | `content/pages/05_vision.json` |

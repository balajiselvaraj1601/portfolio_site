...
| Mode      | Trigger                           | Phases      |
| --------- | --------------------------------- | ----------- |
| Audit     | `audit`, orchestrator Phase 1     | 0→1→5       |
| Accept    | `accept`, orchestrator Phase 4    | 0→2→5       |
| Implement | `implement`, orchestrator Phase 5 | 0→3→4→5     |
| Full      | orchestrator delegates full cycle | 0→1→2→3→4→5 |

...
Ratified from `docs/icon-blend-strategy.md`. The permission criterion is asset _type_, not color count. Org brand marks stay raster regardless of whether they happen to be monochrome.
